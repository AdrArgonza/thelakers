<?php
		...
		$conn = mysqli_connect($host, $user, $pass, $db, $port);
			$fetch="SELECT playername,url,playernumber,playerposition,PPG,height,weight,age,yeardrafted,yearsintheleague,playertext FROM players WHERE playername = '".$playername."'";
